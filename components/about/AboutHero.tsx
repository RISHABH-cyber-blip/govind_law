  ...
  return (
    <section className="relative pt-36 pb-20 bg-black overflow-hidden">
      ...
      <div className="site-container relative z-10 text-center">
        ...
        <h1
          className="font-serif text-white text-5xl md:text-6xl font-semibold mb-4"
          data-aos="fade-up"
        >
          Meet Our Legal Team
        </h1>
        ...
        <p
          ...
          data-aos-delay="100"
        >
          We are a dedicated legal practice committed to delivering fearless,
          ethical, and result-driven representation to every client who walks
          through our doors.
        </p>
