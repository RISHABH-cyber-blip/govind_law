...
export default function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen flex flex-col justify-start overflow-hidden bg-black pt-20">
      {/* Top Banner — 100% Complete Image (No Cropping) */}
      <div className="site-container relative z-10 w-full pt-4 pb-2">
        <div className="max-w-3xl lg:max-w-4xl mx-auto rounded-2xl overflow-hidden border border-gold/30 shadow-2xl bg-black">
          <Image
            src="/images/govind-nikita-banner.jpeg"
            alt="Govind & Nikita Advocates - Advocates & Partners, New Delhi"
            width={720}
            height={328}
            priority={true}
      ...
      <div className="site-container relative z-10 w-full py-8 md:py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div>
            ...
            >
              <i
                className="fas fa-scale-balanced text-gold text-xs"
                aria-hidden="true"
              />
            ...
            <div ref={contentRef}>
              <p className="text-gray-300 text-lg leading-relaxed mb-8 max-w-lg">
                Experienced advocates providing confidential, result-oriented
                legal representation across Delhi NCR courts — from Tis Hazari
                to Delhi High Court.
              </p>
          ...
          {/* Right — image mosaic */}
          <div
            className="relative h-[500px] lg:h-[580px] hidden sm:block"
            data-aos="fade-left"
          >
            {/* Main image */}
            <div
            ...
            {/* Stats badge overlay */}
            <div className="absolute bottom-6 left-6 z-20 bg-black/90 backdrop-blur-sm border border-gold/30 rounded-xl px-5 py-3">
              <strong className="font-serif text-gold text-2xl block leading-none">
                150+
              </strong>
